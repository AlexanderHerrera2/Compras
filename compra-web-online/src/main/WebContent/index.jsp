...
<title>Restaurante Camaleon Sabroso</title>
...
<!-- Favicons -->
<link
	href="${pageContext.request.contextPath}/resources/img/shrimp-icon.png"
	rel="icon">
<link
	href="${pageContext.request.contextPath}/resources/img/shrimp-icon.png"
	rel="shrimp-icon">
...
<!-- Vendor CSS Files -->
<link
	href="${pageContext.request.contextPath}/resources/css/animate.css/animate.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/aos/aos.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/bootstrap/css/bootstrap.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/bootstrap-icons/bootstrap-icons.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/boxicons/css/boxicons.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/glightbox/css/glightbox.min.css"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/css/swiper/swiper-bundle.min.css"
	rel="stylesheet">
...
<body>
	...
	<!--         <i class="bi bi-phone d-flex align-items-center"><span>+593994651102</span></i> -->
	<!--         <i class="bi bi-clock d-flex align-items-center ms-4"><span> Lun-Sab: 10AM-20PM</span></i> -->
	<!--       </div> -->
	...
	<header id="header" class="fixed-top d-flex align-items-cente">
		<div
			...
			<h1 class="logo me-auto me-lg-0">
				<a href="index.jsp">CAMALEON SABROSO</a>
			</h1>
			<a href="index.jsp" class="logo me-auto me-lg-0"><img
				src="${pageContext.request.contextPath}/resources/img/shrimp-icon.png"
			...
			<nav id="navbar" class="navbar order-last order-lg-0">
				<ul>
					...
					<!-- Compras -->
					<li class="dropdown"><a href="#"><span>Compras</span> <i
							class="bi bi-chevron-down"></i></a>
						<ul>
							<li class="dropdown"><a href="#"><span>Facturación</span>
									<i class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="#">Lista de Facturas</a></li>
									<li><a href="#">Lista Factura Detalles</a></li>
								</ul></li>
							<li class="dropdown"><a href="#"><span>Pedidos</span> <i
									class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="#">Lista Pedidos</a></li>
									<li><a href="#">Lista Pedidos Detalles</a></li>
								</ul></li>
							<li class="dropdown"><a href="#"><span>Compras</span> <i
									class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="/compra-web-online/compras/findAll">Lista
											de Compras</a></li>
									<li><a href="/compra-web-online/DetallesCompras/findAll">Lista
											Compras Detalles</a></li>
								</ul></li>
							<li class="dropdown"><a href="#"><span>Devoluciones</span>
									<i class="bi bi-chevron-right"></i></a>
								<ul>
									<li><a href="#">Lista de Devoluciones</a></li>
									<li><a href="#">Lista Devoluciones Detalles</a></li>
								</ul></li>
						</ul></li>

					<!-- Inventario -->

					<li class="dropdown"><a href="#"><span>Inventario</span> <i
							class="bi bi-chevron-down"></i></a>
						<ul>
					...
					<li class="dropdown"><a href="#"><span>Pagos y
								Envíos</span> <i class="bi bi-chevron-down"></i></a>
						<ul>
							<li><a href="#">Envio</a></li>
							<li><a href="#">Pago</a></li>
							<li><a href="#">Tipo Pago</a></li>
						</ul></li>

					<!-- Clientes y Vendedores -->

					<li class="dropdown"><a href="#"><span>Clientes y
								Vendedores</span> <i class="bi bi-chevron-down"></i></a>
						<ul>
							<li><a href="#">Clientes</a></li>
							<li><a href="#">Vendedores</a></li>
							<li><a href="#">Promociones</a></li>
							<li><a href="#">Clientes Promociones</a></li>
							<li><a href="#">Vendedores Promociones</a></li>
						</ul></li>
			...
			<!-- .navbar -->
			<a href="#book-a-table"
				class="book-a-table-btn scrollto d-none d-lg-flex">Reservacion</a>
	...
	<section id="hero" class="d-flex align-items-center">
		<div class="container position-relative text-center text-lg-start"
			...
			<div class="row">
				<div class="col-lg-8">
					<h1>
						Bienvenido a <span>CAMALEON SABROSO</span>
					</h1>
					<h2>el mejor Restaurant Gourmet</h2>

					<div class="btns">
						<a href="#menu" class="btn-menu animated fadeInUp scrollto">Menu</a>
						<a href="#book-a-table"
							class="btn-book animated fadeInUp scrollto">Resevacion</a>
					</div>
				</div>
				<div
					class="col-lg-4 d-flex align-items-center justify-content-center position-relative"
					data-aos="zoom-in" data-aos-delay="200">
					<a href="https://www.youtube.com/watch?v=mPufqoACksA"
	...
	<main id="main">
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row">
					...
					<div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
						<h3>En Camaleon Sabroso procuramos</h3>
						<p class="fst-italic">ofrecerte una experiencia culinaria
							única, fusionando sabores tradicionales con toques innovadores.
							Nos comprometemos a usar ingredientes frescos y de alta calidad,
							y a brindarte un servicio excepcional para que cada visita sea
							memorable.</p>
						<ul>
						...
						<p>Descubre nuestro variado menú, que incluye una amplia
							selección de platos preparados con los ingredientes más frescos y
							de la mejor calidad. Desde aperitivos hasta postres, cada plato
							es una obra de arte culinaria.</p>
					</div>
				</div>
			...
			<div class="container" data-aos="fade-up">
				...
				<div class="row menu-container" data-aos="fade-up"
					...
					<div class="col-lg-6 menu-item filter-starters">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/lobster-bisque.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Lobster Bisque</a><span>$5.95</span>
						</div>
						<div class="menu-ingredients">Lorem, deren, trataro, filede,
							nerada</div>
					</div>

					<div class="col-lg-6 menu-item filter-specialty">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/bread-barrel.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
					...
					<div class="col-lg-6 menu-item filter-starters">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/cake.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Crab Cake</a><span>$7.95</span>
						</div>
						<div class="menu-ingredients">A delicate crab cake served on
							a toasted roll with lettuce and tartar sauce</div>
					</div>

					<div class="col-lg-6 menu-item filter-salads">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/caesar.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
					...
					<div class="col-lg-6 menu-item filter-specialty">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/tuscan-grilled.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Tuscan Grilled</a><span>$9.95</span>
						</div>
						<div class="menu-ingredients">Grilled chicken with
							provolone, artichoke hearts, and roasted red pesto</div>
					</div>

					<div class="col-lg-6 menu-item filter-starters">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/mozzarella.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
					...
					<div class="col-lg-6 menu-item filter-salads">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/greek-salad.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Greek Salad</a><span>$9.95</span>
						</div>
						<div class="menu-ingredients">Fresh spinach, crisp romaine,
							tomatoes, and Greek olives</div>
					</div>

					<div class="col-lg-6 menu-item filter-salads">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/spinach-salad.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Spinach Salad</a><span>$9.95</span>
						</div>
						<div class="menu-ingredients">Fresh spinach with mushrooms,
							hard boiled egg, and warm bacon vinaigrette</div>
					</div>

					<div class="col-lg-6 menu-item filter-specialty">
						<img
							src="${pageContext.request.contextPath}/resources/img/menu/lobster-roll.jpg"
							class="menu-img" alt="">
						<div class="menu-content">
							<a href="#">Lobster Roll</a><span>$12.95</span>
						</div>
						<div class="menu-ingredients">Plump lobster meat, mayo and
							crisp lettuce on a toasted bulky roll</div>
					</div>
		...
		<section id="specials" class="specials">
			<div class="container" data-aos="fade-up">
				...
				<div class="section-title">
					<h2>Especiales</h2>
					<p>Consultas nuestras Especiales</p>
				</div>
					...
					<div class="col-lg-3">
						<ul class="nav nav-tabs flex-column">
							<li class="nav-item"><a class="nav-link active show"
								data-bs-toggle="tab" href="#tab-1">Modi sit est</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" href="#tab-2">Unde praesentium sed</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" href="#tab-3">Pariatur explicabo vel</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" href="#tab-4">Nostrum qui quasi</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" href="#tab-5">Iusto ut expedita aut</a></li>
						</ul>
					</div>
						...
						<div class="tab-content">
							<div class="tab-pane active show" id="tab-1">
								<div class="row">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/img/specials-1.png"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-2">
								<div class="row">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/img/specials-2.png"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-3">
								<div class="row">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/img/specials-3.png"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-4">
								<div class="row">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/img/specials-4.png"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
							<div class="tab-pane" id="tab-5">
								<div class="row">
									...
									<div class="col-lg-4 text-center order-1 order-lg-2">
										<img
											src="${pageContext.request.contextPath}/resources/img/specials-5.png"
											alt="" class="img-fluid">
									</div>
								</div>
							</div>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="row event-item">
								<div class="col-lg-6">
									<img
										src="${pageContext.request.contextPath}/resources/img/event-birthday.jpg"
										class="img-fluid" alt="">
								</div>
								<div class="col-lg-6 pt-4 pt-lg-0 content">
									...
									<ul>
										...
										<li><i class="bi bi-check-circled"></i> Duis aute irure
						...
						<div class="swiper-slide">
							<div class="row event-item">
								<div class="col-lg-6">
									<img
										src="${pageContext.request.contextPath}/resources/img/event-private.jpg"
										class="img-fluid" alt="">
								</div>
								<div class="col-lg-6 pt-4 pt-lg-0 content">
						...
						<div class="swiper-slide">
							<div class="row event-item">
								<div class="col-lg-6">
									<img
										src="${pageContext.request.contextPath}/resources/img/event-custom.jpg"
										class="img-fluid" alt="">
								</div>
								<div class="col-lg-6 pt-4 pt-lg-0 content">
			...
			<div class="container" data-aos="fade-up">
				...
				<form action="forms/book-a-table.php" method="post" role="form"
					...
					<div class="mb-3">
						...
						<div class="sent-message">Su solicitud de reserva fue
							enviada. Le devolveremos la llamada o le enviaremos un correo
							electrónico para confirmar su reserva. ¡Gracias!</div>
					</div>
					...
					<div class="swiper-wrapper">
						...
						<div class="swiper-slide">
							<div class="testimonial-item">
								...
								<img
									src="${pageContext.request.contextPath}/resources/img/testimonials/testimonials-5.jpg"
									class="testimonial-img" alt="">
								<h3>John Larson</h3>
								<h4>Entrepreneur</h4>
							</div>
					...
					<div class="col-lg-3 col-md-4">
						<div class="gallery-item">
							<a
								...
								class="gallery-lightbox" data-gall="gallery-item"> <img
		...
		<section id="contact" class="contact">
			...
			<div data-aos="fade-up"
				style="margin: 0 auto; width: 50%; height: 350px;">
				<iframe style="width: 100%; height: 100%;"
					src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d434.16422028928434!2d-78.40228508908812!3d-0.21611896591207097!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x91d5914bf2f2ed11%3A0xd241dc7aa4bca09!2sInstituto%20Tecnol%C3%B3gico%20Universitario%20ISMAC!5e0!3m2!1ses-419!2sec!4v1722438943645!5m2!1ses-419!2sec"
					...
					<div class="col-lg-4">
						<div class="info">
							...
							<div class="open-hours">
								...
								<h4>Horarios</h4>
								<p>
									Lunes-Sabado<br> 11:00 AM - 20:00 PM
								</p>
							</div>
							...
							<div class="email">
								...
								<h4>Email:</h4>
								<p>CamaleonSabroso@example.com</p>
							</div>
	...
	<footer id="footer">
				...
				<div class="row">
					...
					<div class="col-lg-3 col-md-6">
						<div class="footer-info">
							<h3>Camaleon Sabroso</h3>
							<p>
								Belermo S2-02 Y<br> Quito 170184<br>
								<br> <strong>Telefono:</strong> +593994651102<br> <strong>Email:</strong>
								CamaleonSabroso@example.com<br>
							</p>
					...
					<div class="col-lg-2 col-md-6 footer-links">
						...
						<ul>
							...
							<li><i class="bx bx-chevron-right"></i> <a href="#">Acerca
									de</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Servicios</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Términos
									de servicio</a></li>
							<li><i class="bx bx-chevron-right"></i> <a href="#">Politica
									de privacidad</a></li>
						</ul>
					</div>
					...
					<div class="col-lg-4 col-md-6 footer-newsletter">
						...
						<p>Mantente al día con las últimas novedades de nuestro
							restaurante. Suscríbete a nuestro boletín y sé el primero en
							descubrir nuestros nuevos platos, eventos especiales y
		...
		<div class="container">
			<div class="copyright">
				&copy; Copyright <strong><span>Camaleon Sabroso</span></strong>.
	...
	<script
		src="${pageContext.request.contextPath}/resources/vendor/glightbox/js/glightbox.min.js"></script>
	<script
	...
	<script
		src="${pageContext.request.contextPath}/resources/vendor/swiper/swiper-bundle.min.js"></script>
